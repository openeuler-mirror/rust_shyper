...
use super::{
    ...
    VmMemoryConfig, VmPassthroughDeviceConfig, VmRegion, vm_cfg_set_config_name, PassthroughRegion,
    vm_cfg_add_vm_entry, VmEmulatedDeviceConfigList, VMDtbDevConfigList,
};
